...
describe('StreakCard Component & Flame Icon Frontend Tests', () => {
  ...
  test('StreakCard renders current streak and longest streak metrics with active status when typed today', () => {
    const mockStreak = {
      currentStreak: 5,
      longestStreak: 12,
      activeToday: true,
      ...
      recentDays: [
        ...
        { date: '2026-09-04', dayLabel: 'Fri', active: false, isToday: false },
    ...
    assert.ok(html.includes('Daily Streak'), 'Should display widget title Daily Streak');
    ...
    assert.ok(html.includes('day-practiced'), 'Should include active day classes');
    assert.ok(html.includes('day-missed'), 'Should include missed day classes');
  });

  test('StreakCard renders unlit pending state when user has not typed today', () => {
    const mockStreak = {
      currentStreak: 0,
      longestStreak: 8,
      activeToday: false,
      ...
      recentDays: [
        ...
        { date: '2026-09-05', dayLabel: 'Sat', active: true, isToday: false },
        { date: '2026-09-06', dayLabel: 'Sun', active: false, isToday: false },
        { date: '2026-09-07', dayLabel: 'Mon', active: true, isToday: false },
        { date: '2026-09-08', dayLabel: 'Tue', active: true, isToday: false },
        { date: '2026-09-09', dayLabel: 'Wed', active: false, isToday: true },
      ],
    };
